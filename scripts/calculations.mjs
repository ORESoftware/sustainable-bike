...
export function roadSpeedMph({
  ...
  const metresPerHour = wheelRpm * wheelCircumferenceM * 60;
  return metresPerHour / 1609.344;
}
...
export function summary() {
  ...
  return {
    design,
    speedsMph: design.internalRatios.map((ratio) => ({
      ratio,
      mph: roadSpeedMph({ internalRatio: ratio }),
    })),
